if (WIN32)
    set(WR_IMGUI_BACKEND_SYSTEM_SRC imgui_impl_glfw.cpp)
endif ()
...
add_library(
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/third_party/imgui/backends/${WR_IMGUI_BACKEND_SYSTEM_SRC}
)
target_link_libraries(imgui PUBLIC ${WR_RUNTIME_LIBS})
